...
public class ShortestPathJob extends ExampleBaseJob {
	 ...
	 */
	public static class SearchMapperSSSP extends BFSSearchMapper {
		...
		throws IOException, InterruptedException {
			...
			//calls the map method of the super class BFSSearchMapper
...
public static class SearchReducerSSSP extends BFSSearchReducer{
	...
	public void reduce(Text key, Iterable<Text> values, Context context)
		   ...
		   //create a new out node and set its values
			...
			//call the reduce method of BFSSearchReducer class 
